...
export const UI_ASSETS = {
  ...
  "two-player-badge": assetUrl("./ui/two-player-badge.png"),
...
export const AUDIO_ASSETS = {
  ...
  "kind-push-1": assetUrl("./audio/kind-push-1.wav"),
  "kind-push-2": assetUrl("./audio/kind-push-2.wav"),
  "kind-push-3": assetUrl("./audio/kind-push-3.wav"),
  "kind-push-4": assetUrl("./audio/kind-push-4.wav"),
  "kind-push-5": assetUrl("./audio/kind-push-5.wav"),
  "kind-push-6": assetUrl("./audio/kind-push-6.wav"),
  "kind-push-7": assetUrl("./audio/kind-push-7.wav"),
  "need-intakt-1": assetUrl("./audio/need-intakt-1.wav"),
  "need-intakt-2": assetUrl("./audio/need-intakt-2.wav"),
  "need-intakt-3": assetUrl("./audio/need-intakt-3.wav"),
  "polite-waiting-1": assetUrl("./audio/polite-waiting-1.wav"),
  "polite-waiting-2": assetUrl("./audio/polite-waiting-2.wav"),
  "polite-waiting-3": assetUrl("./audio/polite-waiting-3.wav"),
  "polite-waiting-4": assetUrl("./audio/polite-waiting-4.wav"),
  "polite-waiting-5": assetUrl("./audio/polite-waiting-5.wav"),
  "polite-waiting-6": assetUrl("./audio/polite-waiting-6.wav"),
  "polite-waiting-7": assetUrl("./audio/polite-waiting-7.wav"),
  "polite-waiting-8": assetUrl("./audio/polite-waiting-8.wav"),
  "polite-waiting-9": assetUrl("./audio/polite-waiting-9.wav"),
  "polite-waiting-10": assetUrl("./audio/polite-waiting-10.wav"),
  "polite-waiting-11": assetUrl("./audio/polite-waiting-11.wav"),
  "push-behind-roadblock-happy": assetUrl(
    "./audio/push-behind-roadblock-happy.wav",
  ),
  "push-behind-roadblock": assetUrl("./audio/push-behind-roadblock.wav"),
  "push-behind-trade-happy": assetUrl("./audio/push-behind-trade-happy.wav"),
  "push-behind-trade": assetUrl("./audio/push-behind-trade.wav"),
  ...
  "polite-roadblock-1": assetUrl("./audio/roadblocks/polite-roadblock-1.wav"),
  "polite-roadblock-2": assetUrl("./audio/roadblocks/polite-roadblock-2.wav"),
  "polite-roadblock-3": assetUrl("./audio/roadblocks/polite-roadblock-3.wav"),
  "polite-roadblock-4": assetUrl("./audio/roadblocks/polite-roadblock-4.wav"),
  "polite-roadblock-5": assetUrl("./audio/roadblocks/polite-roadblock-5.wav"),
  "polite-roadblock-6": assetUrl("./audio/roadblocks/polite-roadblock-6.wav"),
  "polite-roadblock-7": assetUrl("./audio/roadblocks/polite-roadblock-7.wav"),
  "polite-roadblock-8": assetUrl("./audio/roadblocks/polite-roadblock-8.wav"),
  "polite-roadblock-9": assetUrl("./audio/roadblocks/polite-roadblock-9.wav"),
